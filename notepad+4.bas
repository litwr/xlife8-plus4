 ...
 2520 if q then print chr$(27)"o";:q=0
 2530 return
 ...
 2730 ifi=171then poke2024,39:print chr$(147)"Welcome to Basic":end
 ...
 3080 a$(lc)=a$(lc)+cf$:gosub7100
 3090 close8:s$=ds$
 3100 gosub2200:goto2400

 3120 scnclr:gosub2900:print f$" bad":print ds$
 3130 getkeyc$:gosub9700:goto3090

 3200 rem save
 3210 scnclr:s$="":print"unit"u,f$
